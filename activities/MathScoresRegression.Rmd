...
As FARMS precentage increases, the percent of those who met or exceed math expectation is expected to inscrease as well. 
...
I think this model is worth using because it proves that there is a positive relationship between FARMS and meeting expectations. The really small p-value also shows that the relationship is most likely due to causation. 
...
The largest differences between the predicted and actual scores are where schools who are expecting to score well are doing worse than said expectation. 
...
The schoolboard member is technically supported by the evidence, but his claim is a little oversimplified. I'd draw the conclusion that kids being fed supports better test scores, and that the linear regression model supports that.

For an article about this, I'd zero in on the schools who are performing worse than they are expected to due to the model. 
