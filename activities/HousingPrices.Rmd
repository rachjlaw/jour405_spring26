...
After disucssion of the results, each person writes a couple of sentences for the top of a story about local officials' claims on the impact of the transit line and what the data says. Remember that there are lots of possible reasons that could influence the price of a home. Make your sentences newsy.

A new light rail through a local neighborhood may be affecting housing prices according to a study done by local officials. 

Before the light rail was built, the average price of 14 homes in the area was about $285 thousand. After its construction, those same houses would sell for an average of $304 thousand, increasing the average price for them by $19.5 thousand, according to data provided by the city. The data has a conference interval of 95%, meaning it's likely that housing prices will continue to rise by 6.8% in the light rails area. 
