...
Ten cities are from the 90th percentile. 
...
```{r}
comp <- read_csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/md_cities_crime_2019_2020.csv")

comp |>
  summarize(
    iqr_violent_rate_2020 = IQR(violent2020),
)
```
...
I think this makes sense with my data, mostly because (I think) it mans half of data shows a 17% increase in crime. This doesn't change my story idea, because like I mentioned in the first assignment, outliers are the most interesting part of this data set. 
