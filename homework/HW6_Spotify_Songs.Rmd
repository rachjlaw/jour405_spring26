...
I think the danceability scores are 80% normal, but a little skewed left. I think there's a notable tail closer to a danceability score of 0, even though at least 75% of the data is within one standard deviation. The mean and distribution say that the average danceability score is around 67%, which means that these people rated this list of songs about two-thirds danceable. Basically, this is a generally "danceable" playlist. 
