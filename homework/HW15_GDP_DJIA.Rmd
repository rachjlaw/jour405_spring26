...
gdp_data |> 
  ...
  ggtitle("Correlation between the Stock Market and US GDP")
```
...
The scatterplot (and the correlation coefficient) show that there is a strong relationship between the national GDP and the Dow Jones Industrial average. The scatterplot specifically shows that as the stock market average increases, the national GDP increases as well. 
